      ...
      <nav className="container mx-auto px-4 py-5">
        <div className="flex items-center justify-between">
          ...
          <a href="#inicio" className="flex items-center gap-3 group">
            <img alt="Maple Digital - Soluções Digitais" className="h-14 w-auto transition-opacity group-hover:opacity-80" src="/lovable-uploads/c4ce4ef4-d121-4ef0-a2de-d30a708560ab.png" />
