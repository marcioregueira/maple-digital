...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-black/90 border-t border-border overflow-hidden">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <span>contato@solucdigital.com</span>
              </a>
              <a 
            ...
            <div className="flex gap-3">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className="w-12 h-12 rounded-xl bg-primary/20 hover:bg-primary flex items-center justify-center transition-all duration-300 group"
                >
