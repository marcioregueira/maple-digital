  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-20 md:pt-40 md:pb-32 relative overflow-hidden min-h-[85vh]">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-[1]">
          ...
          {[
            { top: '5%', left: '3%', size: 80, rotate: 15, opacity: 0.25 },
            { top: '15%', left: '12%', size: 50, rotate: -25, opacity: 0.20 },
            { top: '8%', right: '8%', size: 70, rotate: 45, opacity: 0.22 },
            { top: '25%', right: '3%', size: 55, rotate: -10, opacity: 0.18 },
            { top: '45%', left: '5%', size: 65, rotate: 30, opacity: 0.20 },
            { top: '60%', left: '2%', size: 45, rotate: -35, opacity: 0.22 },
            { top: '70%', right: '5%', size: 60, rotate: 20, opacity: 0.20 },
            { top: '80%', left: '10%', size: 55, rotate: -15, opacity: 0.25 },
            { top: '35%', right: '12%', size: 40, rotate: 50, opacity: 0.18 },
            { top: '55%', right: '2%', size: 75, rotate: -40, opacity: 0.22 },
            { top: '85%', right: '15%', size: 50, rotate: 35, opacity: 0.20 },
            { top: '12%', left: '45%', size: 35, rotate: -20, opacity: 0.15 },
            { top: '75%', left: '40%', size: 45, rotate: 25, opacity: 0.18 },
          ].map((leaf, index) => (
            <svg
              key={index}
