...
const PortfolioPage = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-20 md:pt-40 md:pb-32 relative overflow-hidden min-h-[85vh]">
        ...
        {/* Decorative Maple Leaves Background - Outline Style */}
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-[1]">
          {[
            // Top row - larger leaves on edges, smaller in middle
            { top: '2%', left: '1%', size: 90, rotate: -15, opacity: 0.35 },
            { top: '5%', left: '18%', size: 55, rotate: 10, opacity: 0.25 },
            { top: '3%', left: '42%', size: 50, rotate: -5, opacity: 0.22 },
            { top: '6%', left: '58%', size: 45, rotate: 15, opacity: 0.20 },
            { top: '4%', right: '18%', size: 55, rotate: -20, opacity: 0.25 },
            { top: '2%', right: '1%', size: 85, rotate: 25, opacity: 0.30 },
            
            // Second row
            { top: '18%', left: '3%', size: 65, rotate: 20, opacity: 0.28 },
            { top: '22%', left: '28%', size: 45, rotate: -30, opacity: 0.18 },
            { top: '20%', left: '52%', size: 40, rotate: 5, opacity: 0.16 },
            { top: '18%', right: '25%', size: 48, rotate: -15, opacity: 0.20 },
            { top: '22%', right: '5%', size: 60, rotate: 35, opacity: 0.25 },
            
            // Third row
            { top: '38%', left: '2%', size: 75, rotate: -25, opacity: 0.30 },
            { top: '42%', left: '22%', size: 50, rotate: 15, opacity: 0.20 },
            { top: '40%', left: '48%', size: 42, rotate: -10, opacity: 0.18 },
            { top: '38%', right: '22%', size: 52, rotate: 25, opacity: 0.22 },
            { top: '42%', right: '3%', size: 70, rotate: -35, opacity: 0.28 },
            
            // Fourth row
            { top: '58%', left: '5%', size: 68, rotate: 30, opacity: 0.28 },
            { top: '62%', left: '30%', size: 38, rotate: -20, opacity: 0.16 },
            { top: '60%', right: '32%', size: 42, rotate: 10, opacity: 0.18 },
            { top: '58%', right: '6%', size: 65, rotate: -25, opacity: 0.26 },
            
            // Bottom row - larger leaves on edges
            { top: '75%', left: '1%', size: 95, rotate: -10, opacity: 0.38 },
            { top: '78%', left: '20%', size: 58, rotate: 25, opacity: 0.24 },
            { top: '82%', left: '42%', size: 45, rotate: -15, opacity: 0.20 },
            { top: '80%', right: '35%', size: 48, rotate: 20, opacity: 0.22 },
            { top: '78%', right: '15%', size: 62, rotate: -30, opacity: 0.26 },
            { top: '76%', right: '1%', size: 90, rotate: 15, opacity: 0.35 },
          ].map((leaf, index) => (
            <svg
              key={index}
              className="absolute"
              ...
              strokeWidth="1.5"
            >
              {/* Detailed Maple Leaf Outline */}
              <path 
                className="text-muted-foreground"
                d="M50 5 L52 18 L58 16 L62 22 L72 18 L68 28 L78 26 L72 36 L85 38 L72 44 L82 52 L68 52 L75 65 L62 58 L65 72 L50 58 L35 72 L38 58 L25 65 L32 52 L18 52 L28 44 L15 38 L28 36 L22 26 L32 28 L28 18 L38 22 L42 16 L48 18 L50 5 M50 58 L50 95" 
              />
              {/* Center vein */}
              <path 
                className="text-muted-foreground"
              ...
              <path 
                className="text-muted-foreground"
                d="M50 35 L38 28 M50 35 L62 28 M50 45 L32 42 M50 45 L68 42" 
                strokeWidth="0.8"
              />
            </svg>
          ))}
